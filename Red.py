...
def obtener_nuevo_amigo(amigos):
    nuevo_amigo = input("Para agregar un nuevo amigo dinos como se llama. ")
...
def opcion_menu():
    ...
    print("  6. Mostrar los ultimos estados de tus amigos")
    print("  0. Salir")
...
def mostar_ult_est_amigos(amigos):
    print("--------------------------------------------------")
    for amigosN in range(len(amigos)):
        if existe_archivo(amigos[amigosN]+".user"):
            archivo_usuario = open(amigos[amigosN]+".user","r")
            ...
            print(amigos[amigosN], "dice:", estado)
    print("--------------------------------------------------")
